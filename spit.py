...
def print_directory_structure(path, depth=None, ignored=None, verbose=False, indent=0):
    ...
    for item in sorted(os.listdir(path)):
        ...
        print_directory_structure(os.path.join(path, item), next_depth, ignored, verbose, indent + 1)
...
def main():
    ...
    parser.add_argument('-verbose', '-v', action='store_true', help="Verbose mode. Ignores all default ignored directories and files.")
    ...
    print_directory_structure(os.getcwd(), args.depth, ignored, args.verbose)
